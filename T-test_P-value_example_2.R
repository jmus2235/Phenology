...
DOY <- c(229, 218, 214, 215, 219, 228, 216, 222, 207, 210, 231, 221, 214, 211, 214, 225, 207, 225, 211, 223)
...
meanEVI_DOY_filt1 <- filter(meanEVI_DOY, year <2013)
meanEVI_DOY_filt1$GROUP <- 'A'

meanEVI_DOY_filt2 <- filter(meanEVI_DOY, year >2012)
meanEVI_DOY_filt2 <- filter(meanEVI_DOY_filt2, year <2023)
